...
#                     fanfold_supplier_lat = item.get('Fanfold_Supplier_Latitude__c', 'Unknown')
#                     fanfold_supplier_lon = item.get('Fanfold_Supplier_Longitude__c', 'Unknown')
#                     shipping_lat = item.get('ShippingLatitude', 'Unknown')
#                     shipping_lon = item.get('ShippingLongitude', 'Unknown')
#
#                     # Construct the file name using latitude and longitude values
#                     file_name = (
#                         f"{fanfold_supplier_lat}_{fanfold_supplier_lon}_"
#                         f"{shipping_lat}_{shipping_lon}.json"
#                     )
#
